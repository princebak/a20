...
s_a[50]="Bas-Uele|Equateur|Haut-Katanga|Haut-Lomami|Haut-Uele|Ituri|Kasaï|Kasaï central|Kasaï oriental|Kinshasa	|Kongo-Central|Kwango|Kwilu|Lomami|Lualaba|Mai-Ndombe|Maniema|Mongala|Nord-Kivu|Nord-Ubangi|Sankuru|Sud-Kivu|Sud-Ubangi|Tanganyika|Tshopo|Tshuapa";
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.options[0] = new Option('Votre Ville','');
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Votre Pays','-1');
